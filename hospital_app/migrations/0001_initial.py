    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('NURSE', 'Nurse'), ('STAFF', 'Staff'), ('DOCTOR', 'Doctor'), ('HEAD', 'Head of camp'), ('VOLUNTEER', 'Volunteer')], default='STAFF', editable=False, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_date', models.DateField(default=datetime.date(2000, 1, 1))),
            ],
        ),
        migrations.CreateModel(
            name='Nurse',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_date', models.DateField(default=datetime.date(2000, 1, 1))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(default=datetime.date(2000, 1, 1))),
                ('symptom_name', models.CharField(max_length=50)),
                ('duration', models.IntegerField(default=None, editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treatment_period', models.IntegerField(default=None, editable=False, null=True)),
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.doctor')),
                ('medication_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.medication')),
                ('patient_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.patient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(default=None, primary_key=True, serialize=False)),
                ('transfer_date', models.DateField(default=datetime.date(2000, 1, 1))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('admission_date', models.DateField(default=datetime.date(2000, 1, 1))),
                ('location', models.TextField(blank=True, null=True)),
                ('discharge_date', models.DateField(blank=True, default=None, null=True)),
                ('patient_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.patient')),
                ('staff_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.staff')),
